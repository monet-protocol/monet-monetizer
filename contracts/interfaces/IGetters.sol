...
interface IGetters {
  ...
  /// @notice Stablecoin minted by monetizer
  ...
  /// @notice Returns the collateral ratio of Monetizer in base `10**9` and a rounded version of the total amount
  /// of stablecoins issued
  function getCollateralRatio() external view returns (uint64 collatRatio, uint256 stablecoinsIssued);

  /// @notice Returns the total amount of stablecoins issued through Monetizer
