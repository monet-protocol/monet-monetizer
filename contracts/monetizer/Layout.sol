...
import { DiamondStorage, MonetizerStorage, Collateral, FacetInfo, WhitelistType } from "./Storage.sol";

/// @notice Contract mimicking the overall storage layout of the monetizer system.
...
contract Layout {
  ...
  // uint256(DIAMOND_STORAGE_POSITION) - MonetizerStorage offset (9) - uint256(TRANSMUTER_STORAGE_POSITION)
