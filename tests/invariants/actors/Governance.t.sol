...
import { BaseActor, IMonetizer, AggregatorV3Interface, IERC20, IERC20Metadata } from "./BaseActor.t.sol";
...
contract Governance is BaseActor, FunctionUtils {
  ...
  constructor(
    ...
    BaseActor(1, "Trader", monetizer, transmuterSplit, collaterals, oracles)
  { }
