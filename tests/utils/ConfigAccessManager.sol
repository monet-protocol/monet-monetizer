...
abstract contract ConfigAccessManager is Helper {
  ...
  function getMonetizerGuardianSelectorAccess() internal pure returns (bytes4[] memory) {
  ...
  function getMonetizerGovernorSelectorAccess() internal pure returns (bytes4[] memory) {
