...
import { LibDiamond } from "contracts/monetizer/libraries/LibDiamond.sol";
...
contract Test_DiamondCut is Fixture {
  ...
  function test_RevertWhen_NotGovernor() public {
    ...
    hoax(guardian);
    monetizer.diamondCut(facetCut, address(0x0), "");
  }
  ...
  function test_RevertWhen_IncorrectFacetCutAction() public {
    ...
    hoax(governor);
    DiamondCutAux(address(monetizer)).diamondCut(facetCut, address(0x0), "");
  }
  ...
  function test_RevertWhen_InitializerHasNoCode() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, address(1), "");
  }
  ...
  function test_RevertWhen_InitializerRevert() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, initializer, abi.encodeWithSelector(MockInitializer.initializeRevert.selector));
  }
  ...
  function test_RevertWhen_AddToZeroAddress() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, address(0), "");
  }
  ...
  function test_AddSimplePureFacet() public {
    ...
    assertEq(IMockFacet(address(monetizer)).newFunction(), 1);
    assertEq(IMockFacet(address(monetizer)).newFunction2(), 2);
  }
  ...
  function test_AddSimpleWriteFacet() public {
    ...
    assertEq(IMockFacet(address(monetizer)).newFunction(), 0);
    assertEq(IMockFacet(address(monetizer)).newFunction2(), 1);
  }
  ...
  function test_AddWriteFacetWithInitializer() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, initializer, abi.encodeWithSelector(MockInitializer.initialize.selector));

    assertEq(IMockFacet(address(monetizer)).newFunction(), 2); // 2 because of the initializer
    assertEq(IMockFacet(address(monetizer)).newFunction2(), 1);
  }
  ...
  function test_ReplaceReadWithWriteFacet() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, address(0), "0x");
  ...
  function test_ReplaceWriteWithExtendedWriteFacet() public {
    ...
    hoax(governor);
    monetizer.diamondCut(facetCut, address(initializer), abi.encodeWithSelector(MockInitializer.initialize.selector));

    assertEq(IMockFacet(address(monetizer)).newFunction(), 2); // Slot 1 is 2 with the initializer
    assertEq(IMockFacet(address(monetizer)).newFunction2(), 1); // Slot 1 is now 1
    ...
    assertEq(IMockFacet(address(monetizer)).newFunction(), 1); // Slot 1 is still 2
    assertEq(IMockFacet(address(monetizer)).newFunction2(), 20); // Slot 2 is 20
  }
